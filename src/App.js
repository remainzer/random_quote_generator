    ...
    return (
      <div className="App">
        <div id="quote-box">
          ...
          <div id="helperDIV"><a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(quoteAuthor)}`} id="tweet-quote" target="_blank"><i className="fa-brands fa-x-twitter"></i></a></div>
